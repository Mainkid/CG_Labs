...
DotedLine::DotedLine(Game* game)
{
	this->game = game;
}

void DotedLine::Initialize()
{
	vertexBC = nullptr;

	D3D_SHADER_MACRO Shader_Macros[] = { "TEST", "1", "TCOLOR", "float4(0.0f, 1.0f, 0.0f, 1.0f)", nullptr, nullptr };

	HRESULT res = D3DCompileFromFile(L"./Shaders/Line.hlsl",
		nullptr /*macros*/,
		nullptr /*include*/,
		"VSMain",
		"vs_5_0",
	...
	if (FAILED(res)) {
		...
		{
			MessageBox(game->window->GetHWND(), L"./Shaders/Line.hlsl", L"Missing Shader File", MB_OK);
		}
	...
	res = D3DCompileFromFile(L"./Shaders/Line.hlsl", Shader_Macros /*macros*/, nullptr /*include*/, "PSMain", "ps_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0, &pixelBC, &errorPixelCode);
	...
	DirectX::XMFLOAT4 points[8] = {
		DirectX::XMFLOAT4(-0.02f, 1.0f, 0.5f, 1.0f),	DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f),
		DirectX::XMFLOAT4(0.02f, 1.0f, 0.5f, 1.0f),	DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f),
		DirectX::XMFLOAT4(0.02f, -1.0f, 0.5f, 1.0f),	DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f),
		DirectX::XMFLOAT4(-0.02f, -1.0f, 0.5f, 1.0f),	DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f),
	};
...
void DotedLine::Update(float deltaSec)
{


}

void DotedLine::InitializeShaders()
{
