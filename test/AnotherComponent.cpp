...
AnotherComponent::AnotherComponent(Game* game)
{
	this->game = game;
}

void AnotherComponent::Initialize()
{
	vertexBC = nullptr;
	...
	DirectX::XMFLOAT4 points[8] = {
		...
		DirectX::XMFLOAT4(1.0f, -0.5f, 0.5f, 1.0f),	DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f),
...
void AnotherComponent::Update(float deltaSec)
{

}

void AnotherComponent::InitializeShaders()
{
